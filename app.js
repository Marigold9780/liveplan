...
const marketCatalog = [
  ...
  {
    id: "bangdream-roselia-lehre-der-rose",
    source: "BanG Dream!",
    sourceUrl: "https://bang-dream.com/events/roselia_2026",
    sourceLabel: "官方活动页",
    artist: "Roselia",
    title: "Roselia 単独ライブ「Lehre der Rose」",
    titleCn: "Roselia 单独 Live「Lehre der Rose」",
    date: "2026-09-05",
    openTime: "",
    startTime: "",
    city: "Tokyo",
    ...
    deadline: "",
    summary: "Roselia 单独公演，场馆为有明アリーナ。适合重点关注票务受付更新。",
    knownInfo: ["官方 Event 列表已公开场次", "会场原文：有明アリーナ", "时间、票种细节建议持续关注官方更新"],
    tags: ["东京", "Roselia", "单独公演"],
  },
  {
    ...
    sourceLabel: "官方活动页",
    artist: "RAISE A SUILEN",
    title: "RAISE A SUILEN ZEPP TOUR 2026「HOWLING AMBITION」東京公演",
    titleCn: "RAISE A SUILEN ZEPP TOUR 2026「HOWLING AMBITION」东京公演",
    date: "2026-06-18",
    openTime: "18:00",
    startTime: "19:00",
    city: "Tokyo",
    ...
    priceMin: 9900,
    priceMax: 9900,
    ticket: "スタンディング公演。入场与整理番号等以官方页面为准。",
    deadline: "",
    summary: "RAISE A SUILEN ZEPP TOUR 东京场，Live 日期较近，适合在提醒中优先处理。",
    knownInfo: ["官方 Event 列表已公开场次", "官方页面显示东京公演为 Zepp Haneda", "开场 / 开演时间以官方页面为准"],
    tags: ["东京", "Zepp", "近期开演"],
  },
  {
    id: "bangdream-ave-mujica-2026",
    source: "BanG Dream!",
    sourceUrl: "https://bang-dream.com/events/avemujica_2026",
    sourceLabel: "官方活动页",
    artist: "Ave Mujica",
    title: "Ave Mujica 6th LIVE",
    titleCn: "Ave Mujica 第 6 次 Live",
    date: "2026-12-12",
    openTime: "",
    startTime: "",
    city: "Tokyo",
    ...
    priceMin: 11000,
    priceMax: 23100,
    ticket: "票务细节以官方页面后续更新为准。",
    deadline: "",
    summary: "Ave Mujica 未来单独公演，适合先加入关注并等待票务更新。",
    knownInfo: ["官方 Event 列表已公开场次", "会场原文：有明アリーナ", "票务细节需要持续同步"],
    tags: ["东京", "Ave Mujica", "待更新"],
  },
];
